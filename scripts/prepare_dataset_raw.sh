...
python ./util/construct_dataset_mat_to_pickle_v1_withRaw.py -t task1-SR
python ./util/construct_dataset_mat_to_pickle_v1_withRaw.py -t task2-NR
python ./util/construct_dataset_mat_to_pickle_v1_withRaw.py -t task3-TSR
python ./util/construct_dataset_mat_to_pickle_v2_withRaw.py
