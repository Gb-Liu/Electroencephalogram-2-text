...
if version == 'v1':
    # old version 
    input_mat_files_dir = f'E:/EEG-To-Text-main1/datasets/ZuCo/{task_name}/Matlab_files'
elif version == 'v2':
    # new version, mat73 
    input_mat_files_dir = f'E:/EEG-To-Text-main1/datasets/ZuCo/{task_name}/Matlab_files'

output_dir = f'E:/EEG-to-Text-Decoding-main/EEG-to-Text-Decoding-main/dataset/ZuCo/{task_name}/pickle'
