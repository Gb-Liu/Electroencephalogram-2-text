...
def get_config(case):
    if case == 'train_decoding': 
        ...
        parser.add_argument('-ne1', '--num_epoch_step1', type = int, help='num_epoch_step1', default = 10, required=True)
        parser.add_argument('-ne2', '--num_epoch_step2', type = int, help='num_epoch_step2', default = 10, required=True)
        ...
        parser.add_argument('-eeg', '--eeg_type', help='choose from {GD, FFD, TRT}', default = ['FFD', 'TRT', 'GD'], required=False)
